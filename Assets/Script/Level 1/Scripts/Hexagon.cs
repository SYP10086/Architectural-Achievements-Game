...
public class Hexagon : MonoBehaviour, IDragHandler, IEndDragHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    {
        Hexagon slotEndHexagon = eventData.pointerCurrentRaycast.gameObject.GetComponent<Hexagon>();
        Hexagon slotDragHexagon = eventData.pointerDrag.GetComponent<Hexagon>();
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        {
            UpdateHexagonTransparency(0.5f);
        }
    }
