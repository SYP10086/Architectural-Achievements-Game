...
public class GuidanceText : MonoBehaviour
{
    ...
    void HandleDestinationCountChange(int currentValue)
    {
        ...
        {
            case 0:
                targetText.text = @"诸位，我这老宅的魂魄，就在一个‘裹’字上。你且看这片园子——山石顺着地势蔓延，林木层层叠叠，将亭台楼阁都‘裹’入怀中。建筑不争不抢，高低错落，像从泥土里长出来似的。这叫‘山形入宅，宅隐于山’。咱们边走边看，你就明白其中的妙处了。/n(按QE转动视角，寻找光点，用鼠标拖动建筑至光点处)";
                break;
            case 1:
